...
export const AddWorkflow = () => {
    ...
    const [hoveredItem, setHoveredItem] = useState<{ id: number; name: string; optional_flag: string } | null>(null);
    ...
    const getProcess = async () => {
        try {
            ...
            const videoProcesses: ProcessItem[] = response.data.data.filter((process: { work_process: string }) => process.work_process === 'VIDEO');
            const bothProcesses: ProcessItem[] = response.data.data.filter((process: { work_process: string }) => process.work_process === 'BOTH');
